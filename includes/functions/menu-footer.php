...
function Technic_menu_page() {
    wp_nav_menu([
        'theme_location'  => 'menu-page',
        'menu'            => 'page',
        'container'       => false,
        'menu_class'      => 'footer__menu-list',
        'walker'          => new Technic_Walker_Nav_menu_page()
    ]);
}
...
class Technic_Walker_Nav_menu_page extends Walker_Nav_Menu {
